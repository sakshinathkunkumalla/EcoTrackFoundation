...
fun DashboardScreen(vm: DashboardViewModel = viewModel()) {
    ...
    Column(
        ...
        MetricCard("Total Active Minutes", vm.getTotalSteps().toString())
        MetricCard("Calories Burned", vm.getTotalCalories().toString())
        MetricCard("CO₂ Saved (kg)", String.format("%.2f", vm.getTotalCO2()))
        Spacer(modifier = Modifier.height(16.dp))
